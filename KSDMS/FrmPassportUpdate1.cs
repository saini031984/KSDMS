...
namespace KSDMS
{
    public partial class FrmPassportUpdate1 : Form
    {
        int SaveAction;
        public int IntVisaStatus;
        public FrmPassportUpdate1()
        {
            InitializeComponent();
        }

        private void FrmPassportUpdate1_Load(object sender, EventArgs e)
        {
        ...
        private void BtnView_Click(object sender, EventArgs e)
        {
            ...
            FrmP.HelpSQL = "Select PassportID as [000,SLNO], FirstNm + ' ' + MidNm + ' ' + LastNm as [200,Name],RegNoStr as [150,RegNo]," +
                ...
                " from PassportApp Where PStatus >= 4  Order By PassportID";
        ...
        private void rectangleShape5_DoubleClick_1(object sender, EventArgs e)
        {
            if (TxtNewLNm.Text.Trim() == "")
            {
                TxtNewLNm.Text = TxtLNm.Text.Trim();
