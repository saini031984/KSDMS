...
namespace KSDMS
{
    public partial class FrmVisaUpdate : Form
    {
        int SaveAction;
        public int IntVisaStatus;
        public FrmVisaUpdate()
        {
            InitializeComponent();
        }

        private void FrmVisaUpdate_Load(object sender, EventArgs e)
        {
        ...
        private void Fn_StatusUPdate()
        {
            ...
            if (CmbStatus.SelectedIndex == 1)
            {
                ...
                {
                    MessageBox.Show("Enter No Of Months", GlobalFunction.A_Name, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    TxtNoOfMoths.Focus();
                    return;
                }
                if (TxtVisaNo.Text.Trim() == "")
                {
                    MessageBox.Show("Enter Visa No", GlobalFunction.A_Name, MessageBoxButtons.OK, MessageBoxIcon.Information);
                    TxtVisaNo.Focus();
                    return;
                }
        ...
        private Boolean Fn_Val()
        {
            ...
            {
                MessageBox.Show("Select Occupation", GlobalFunction.A_Name, MessageBoxButtons.OK, MessageBoxIcon.Information);
                TxtOccupation.Focus();
                BB = false;
            }
        ...
        private void BtnView_Click(object sender, EventArgs e)
        {
            ...
            FrmP.HelpSQL = "Select VisaID as [000,SLNO], FirstNm + ' ' + MidNm + ' ' + LastNm as [200,Name],VisaNo as [150,VisaNo]," +
                " AppNoStr as [150,AppNo], PasportNo as [100,PasportNo], RcptNo as  [100,RcptNo]" +
                " from VisaApp Where VisaStatus>= 3   Order By VisaID";
