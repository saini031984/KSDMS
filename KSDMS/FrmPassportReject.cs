...
namespace KSDMS
{
    public partial class FrmPassportReject : Form
    {
        int SaveAction;
        public string D_MSLNO;
        public string D_AppID;
        public FrmPassportReject()
        {
            InitializeComponent();
        }

        private void FrmPassportReject_Load(object sender, EventArgs e)
        {
            if (D_MSLNO == null)
            {
                this.Close();
        ...
        private void Fn_FillGrid()
        {
            ...
            GvWhy.DataSource = PP.DV_RetGridViewPassport();
            GvWhy.Refresh();
        ...
        private void BtnSave_Click(object sender, EventArgs e)
        {
            ...
            ClassPassport LocM = new ClassPassport();
            string StrActive = "N";
