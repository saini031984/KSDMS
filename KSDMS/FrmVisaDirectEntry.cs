...
namespace KSDMS
{
    public partial class FrmVisaDirectEntry : Form
    {
        int SaveAction;
        public int IntVisaStatus;
        public FrmVisaDirectEntry()
        {
            InitializeComponent();
        }

        private void FrmVisaDirectEntry_Load(object sender, EventArgs e)
        {
        ...
        private void BtnView_Click(object sender, EventArgs e)
        {
            ...
            FrmP.HelpSQL = "Select VisaID as [000,SLNO], FirstNm + ' ' + MidNm + ' ' + LastNm as [200,Name],RegNoStr as [150,RegNo]," +
                ...
                " from VisaApp Where VisaStatus= 4 and EntryType='D' Order By VisaID";
