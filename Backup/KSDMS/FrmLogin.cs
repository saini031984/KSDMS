...
namespace KSDMS
{
    public partial class FrmLogin : Form
    {
        ...
        private void FrmLogin_Load(object sender, EventArgs e)
        {
            ...
            SS = SS + " " + BB + " " + CC;
            //  MessageBox.Show(SS);
            //TxtLoginID.Text = "43R0000007";
            //TxtPassword.Text = "joseph";
        ...
        private void CmdLogin_Click(object sender, EventArgs e)
        {
           ...
           // GlobalFunction.ConStr = "server=sql2501.shared-servers.com,1087;database=senegal;uid=KSAdmin;pwd=rohiTK2211#";
            // GlobalFunction.ConStr ="Server=BSKALA/SQLEXPRESS;Database=KSDB;Integrated Security=True";

            GlobalFunction.A_Name = "KS Import";
