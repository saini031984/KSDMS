...
namespace KSDMS.DataClass
{
    class ClassUserMaster
    {
        ...
        public void Fn_Login(string StrLoginID, string StrPW, ref string StrMsg)
        {
            ...
            SQL = "Select UserID,Password,FirstName,MiddleName,LastName,LocationID,LocName,LocShort,LangKnow,RegionID,LocType from QryUserMaster Where LoginID=@LoginID And IsActive='Y'";
            Com.Connection = Conn;
            Com.CommandText = SQL;
            Com.Parameters.Clear();
